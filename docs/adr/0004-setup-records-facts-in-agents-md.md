...
- Setup's remaining universal job is small: ensure `.scratch/` is not gitignored, seed the facts section, and remove stale `docs/agents/*` files from a prior mattpocock install.
