...
This distinguishes two kinds of deferral. A question below altitude is deferred into a child Epic. A question *at* altitude that conversation simply cannot answer becomes a research or prototype move inside the current session.
