...
One per Task, beside its task file, written by `/archie-software-architecture` in a read-only sub-agent. The engineer, the reviewer and the user all read this same file.
